...
WebUI.selectOptionByValue(findTestObject('Object Repository/select_Tokyo CURA Healthcare Center        _5b4107'), 'Seoul CURA Healthcare Center', 
    true)
...
WebUI.click(findTestObject('Object Repository/td_27'))

WebUI.setText(findTestObject('Object Repository/textarea_Comment_comment'), 'yes')
